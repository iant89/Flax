package com.flax.api.runescape;
...
/**
 * @author Nezzima (Dreambot Forums)
 */
public class AccountCreator {
	...
	public int makeAccount(String dispName, String email_, String password, String age_) throws IOException {
		...
		String USER_AGENT = "Mozilla/5.0 (Macintosh; U; Intel Mac OS X 10.4; en-US; rv:1.9.2.2) Gecko/20100316 Firefox/3.6.2";
